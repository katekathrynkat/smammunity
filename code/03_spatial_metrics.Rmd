...
write_csv(site_centroids,'output_data/03_site_centroids.csv', col_names = TRUE)
...
```{r avg severity within expanded sites, include=FALSE}
...
```{r calculate distance to burn boundary, include=FALSE}
