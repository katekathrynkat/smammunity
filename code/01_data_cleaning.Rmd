...
Original raw data are in raw_data/field_data/smamms_raw.csv; data were entered and proofed by hand from field data sheets. QA/QC checks and queries are to catch mistakes that were made in the field or during data entry (e.g. misread tags, mispelled codes).
...
write_csv(final, 'raw_data/field_data/smamms_clean.csv', col_names = TRUE)
